...
<html lang="en">
	...
	while ($row=mysqli_fetch_array($run)) {
		...
		<div class="container  mt-1 border border-secondary mb-1">
			...
			<div class="row pt-3">
				<div class="col-md-4"><h5>SLC/SE Complition Date:</h5> <?php echo $row['matric_complition_date']  ?></div>
			...
			<div class="row pt-3">
				<div class="col-md-4"><h5>+2/A level Complition Date:</h5> <?php echo $row['fa_complition_date']  ?></div>
				<div class="col-md-4"><h5>+2/A level Awarded Date:</h5> <?php echo $row['fa_awarded_date']  ?></div>
				<div class="col-md-4"><h5>+2/A level Certificate:</h5> <?php echo $row['fa_certificate']  ?></div>
			</div>
			<div class="row pt-3">
