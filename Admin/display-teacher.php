...
<html lang="en">
	...
	?>
		<div class="container  mt-1 border border-secondary mb-1">
				...
				<div class="col-md-8">
					...
					<div class="row">
						...
						<div class="col-md-6">
							...
							<h5>Nationality Id:</h5> <?php echo $row['cnic']  ?><br><br>
			...
			<div class="row pt-3">
				<div class="col-md-4"><h5>SLC/SEE Complition Date:</h5> <?php echo $row['matric_complition_date']  ?></div>
				<div class="col-md-4"><h5>SLC/SEE Awarded Date:</h5> <?php echo $row['matric_awarded_date']  ?></div>
				<div class="col-md-4"><h5>SLC/SEE Certificate:</h5> <?php echo $row['matric_certificate']  ?></div>
			</div>
			<div class="row pt-3">
				<div class="col-md-4"><h5>+2 Complition Date:</h5> <?php echo $row['fa_complition_date']  ?></div>
				<div class="col-md-4"><h5>+2 Awarded Date:</h5> <?php echo $row['fa_awarded_date']  ?></div>
				<div class="col-md-4"><h5>+2 Certificate:</h5> <?php echo $row['fa_certificate']  ?></div>
			</div>
			<div class="row pt-3">
				<div class="col-md-4"><h5>Bachelor Complition Date:</h5> <?php echo $row['ba_complition_date']  ?></div>
				<div class="col-md-4"><h5>Bachelor Awarded Date:</h5> <?php echo $row['ba_awarded_date']  ?></div>
				<div class="col-md-4"><h5>Bachelor Certificate:</h5> <?php echo $row['ba_certificate']  ?></div>
			</div>
			<div class="row pt-3">
				<div class="col-md-4"><h5>Masters Complition Date:</h5> <?php echo $row['ma_complition_date']  ?></div>
				<div class="col-md-4"><h5>Masters Awarded Date:</h5> <?php echo $row['ma_awarded_date']  ?></div>
				<div class="col-md-4"><h5>Masters Certificate:</h5> <?php echo $row['ma_certificate']  ?></div>
			</div>
		</div>
	<?php } ?>
</body>
